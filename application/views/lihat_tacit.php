...
<div class="btn-group" role="group">
    <a class="btn btn-success" href="<?php echo base_url();?>pegawai/edit_knowledge/<?php echo $row->id_tacit?>"><i class="fa fa-edit fa-fw"></i> Sunting</a>
    <a class="btn btn-success" href="<?php echo base_url();?>pegawai/hapus_knowledge/<?php echo $row->id_tacit?>"><i class="fa fa-trash fa-fw"></i> Hapus</a>
</div>
<?php
}
?>
...
<div class="row">
    <div class="col-md-8">
        ...
        <?php
            ...
            {
        ?> 
          <input type="hidden" id="id_tacit" name="id_tacit" value="<?php echo $row->id_tacit;?>">
        <?php
            }
        ?>
          ...
          <input type="hidden" id="id_explicit" name="id_explicit" value="1">
...
<div class="row">
    <div id="munculkomen"> 
        ...
        <?php
            $no=1;
            foreach($komentar_tacit->result() as $row)
            {
        ?>
            <div class="panel panel-default">
                ...
                <?php if(($this->session->userdata('nip') == $nip) || ($this->session->userdata('nip') == $row->nip)){ ?>
                    <button type="button" class="close" aria-label="Close">
                      <span aria-hidden="true"><a href="<?php echo base_url();?>pegawai/hapus_komentar_tacit/<?php echo $row->id_komentar;?>" title="Hapus Komentar">&times;</a></span>
                    </button>
                <?php
                    }
                ?>
